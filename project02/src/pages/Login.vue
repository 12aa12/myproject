<template>
  <div >
    ...
    <el-form status-icon label-width="100px">
      <el-form-item label="用户名" prop="username" class="yong bai">
        <el-input type="text" v-model="ruleForm.username" ref="use"></el-input>
      </el-form-item>
      <el-form-item label="密码" prop="password" class="mi bai">
        <el-input type="password" v-model="ruleForm.password" ref="pas"></el-input>
      </el-form-item>
      <el-form-item label="验证码" prop="yan" class="zheng bai">
        <!-- <el-row :gutter="20"> -->
      ...
      <el-form-item>
        ...
        <a @click="forget" class="wang">忘记密码？</a>
      </el-form-item>
    </el-form>
  </div>
</template>
...
<style lang="scss">
body {
  background-image: url(./img1/bag.png);
  color: white;
}
h1 {
  color: white;
